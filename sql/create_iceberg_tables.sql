...
CREATE TABLE IF NOT EXISTS {{ gold_db }}.vehicle_health_enriched (
    source_file STRING,
    vin STRING,
...
CREATE TABLE IF NOT EXISTS {{ gold_db }}.daily_vehicle_health_summary (
    business_date STRING,
    event_date DATE,
    country STRING,
    customer_region STRING,
...
CREATE TABLE IF NOT EXISTS {{ gold_db }}.service_kpi_summary (
    business_date STRING,
    dealer_id STRING,
    dealer_name STRING,
    country STRING,
...
CREATE TABLE IF NOT EXISTS {{ gold_db }}.data_quality_report (
    dataset_name STRING,
    metric_name STRING,
    metric_value BIGINT,
    status STRING,
